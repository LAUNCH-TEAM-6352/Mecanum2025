...
public class LimelightSubsystem extends SubsystemBase
{
    ...
    {
        return Math.abs(getX()) < DriveTrainConstants.PIDConstants.strafeTol
            && Math.abs(getY()) < DriveTrainConstants.PIDConstants.forwardTol
            && Math.abs(getPose2d().getRotation().getDegrees()) < DriveTrainConstants.PIDConstants.rotTol;
    }
